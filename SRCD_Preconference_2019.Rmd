...
???
 - Many of you will be familir with this figure, from DEl Giu, Ellis & Shirtcliff 
...
???
Worth Taking a Moment to focus on the SRS 
<!-------------------------------->
...
knitr::include_graphics("images/Flow_1.svg")
```
<!----------------------------------->
...
## SRS Adaptation
```{r echo = FALSE, out.width = "700px"}
knitr::include_graphics("images/Flow_2.svg")
```
<!----------------------------------->
...
## SRS Adaptation
```{r echo = FALSE, out.width = "700px"}
knitr::include_graphics("images/Flow_3.svg")
```
<!----------------------------------->
...
Slides available at: https://andrewdismukes.github.io/Presentations_2019_SRCD_EvoDevoPreconference/SRCD_Preconference_2019.html
